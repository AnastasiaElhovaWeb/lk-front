...
function jsVendor() {
    return gulp.src([
        ...
        'src/libs/datepicker/datepicker.min.js',
        'src/libs/datatables/datatables.min.js',
        'src/libs/handlebars/handlebars-v4.1.2.js',
        'src/libs/socket.io/socket.io.js',
...
const build = gulp.parallel(html, css, fonts, svgSpriteBuild, jsVendor, image, copyJs, ajax, templates);
